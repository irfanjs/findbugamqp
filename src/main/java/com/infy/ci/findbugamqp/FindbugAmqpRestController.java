package com.infy.ci.findbugamqp;
...
@Component
@Configuration
public class FindbugAmqpRestController {
	...
	private final Logger logger = LoggerFactory.getLogger(FindbugAmqpRestController.class);
	

	@RequestMapping(value = "/{projectid}/fb/aggregate", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/fb/modulewise", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/fb/week", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/fb/month", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/fb/custom", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/fb/{buildnumber}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
